...
- `project.quality_policy_path`: reference to the dev-owned proof-strategy
  artifact (`TESTING.md`), when used; this skill references it, it does not
  author the strategy.
...
- evidence references, including evidence reports
